 ...
 * 
 * cavalcanti, 3/16/21, 5:53 AM * Add Map
 *      
 *          Map carrosPopulares = new HashMap(): //antes do java 5
 *          Map<String, Double> carrosPopulares = new HashMap<>(); //Generics(jdk 5) - Diamond 
 *          HashMap<String, Double> carrosPopulares = new HashMap<>();
*           Map<String, Double> carrosPopulares2020 = Maps.of("gol", 14,4, 
            "uno", 15,6, "mobi", 16,1 , "hb20", 14,5, "kwid", 15,6);
 */
        ...
        System.out.println("Substitua o consumo do goll por 15.2 km/l: ");
